...
if __name__ == '__main__':
    ...
    pre_one = make_one(length + 1)
    cur_one = make_one(length)
    dp_length = random.randint(1, 9)
    r = random.randint(0, pre_one - 1)

    pos0 = gen_seg0(pre_one, dp_length, r)
    neg0 = gen_seg0(pre_one, dp_length, r)
    pos0, neg0 = trans0(length, pos0, neg0)
